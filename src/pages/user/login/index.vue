...
<template>
  <div class="login-container flex h-screen">
    <!-- <LoginBackground /> -->
    <div class="login-form col-12 flex justify-content-center align-items-center flex-column relative">
      <div
      class="botron col-6 flex justify-content-center align-items-center flex-column relative"
    >
